...
if __name__ == "__main__":
    # Use Tkinter to prompt for multiple PDF files
    root = tk.Tk()
    root.withdraw()  # Hide the main Tkinter window

    pdf_input_paths = filedialog.askopenfilenames(
        filetypes=[("PDF files", "*.pdf")],
        title="Select one or more PDF files to underline the first word on each page"
    )
